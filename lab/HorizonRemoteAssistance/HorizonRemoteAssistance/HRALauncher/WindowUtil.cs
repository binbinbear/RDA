...
namespace HRALauncher
{
    public class WindowUtil
    {
        ...
        [DllImport("user32", SetLastError = true)]
        [return: MarshalAs(UnmanagedType.Bool)]
        public extern static bool EnumThreadWindows(int threadId, EnumWindowProc callback, IntPtr lParam);
        ...
        [DllImport("user32.dll")]
        public static extern IntPtr SendMessage(IntPtr hWnd, uint Msg, long wParam, [MarshalAs(UnmanagedType.LPStr)] StringBuilder lParam);
        ...
        public static HandlesInfo GetChildWindows(IntPtr parent, bool onlyImmediateChilds, String className, String text)
        {
            HandlesInfo result = new HandlesInfo(parent, onlyImmediateChilds, className, text);
        ...
        private static bool EnumWindowAllChildCallBackMethod(IntPtr handle, IntPtr pointer)
        {
            ...
            HandlesInfo list = gch.Target as HandlesInfo;
    ...
    public class HandlesInfo
    {
        ...
        internal HandlesInfo(IntPtr parentHandle, bool onlyImmediateChilds) : this(parentHandle, onlyImmediateChilds, String.Empty, String.Empty) { }
        internal HandlesInfo(IntPtr parentHandle, bool onlyImmediateChilds, String className) : this(parentHandle, onlyImmediateChilds, String.Empty, String.Empty) { }
        internal HandlesInfo(IntPtr parentHandle, bool onlyImmediateChilds, String className, String text)
        {
