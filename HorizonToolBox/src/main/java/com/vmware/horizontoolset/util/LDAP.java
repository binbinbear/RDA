...
public class LDAP{
	...
	public LDAP(String servername, String domain, String username, String password){

			 try {
				 UserContext user = UserContextFactory.userContext(domain, username, password);
	...
	public String getValue(String key){
		...
		searchObject.setSearchScope(SearchControls.OBJECT_SCOPE);
	      ...
	      try {
	         ...
	         answers = ctx.search(COMMON_CONFIG_DN,
	               LDAP_SEARCH_FILTER, attributesToReturn, searchObject);
	   ...
	   public void setAttribute(String key, Object value){
		   if (ctx ==null){
			...
			try {
				...
				ctx.modifyAttributes(COMMON_CONFIG_DN, DirContext.REPLACE_ATTRIBUTE, attrs);
			} catch (NamingException e) {
