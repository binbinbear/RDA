...
import com.vmware.vdi.vlsi.binding.vdi.entity.RDSServerId;
...
import com.vmware.vdi.vlsi.binding.vdi.resources.Farm;
...
import com.vmware.vdi.vlsi.cname.vdi.users.SessionCName;
import com.vmware.vim.binding.vmodl.DataObject;
import com.vmware.vim.vmomi.client.http.HttpConfiguration;
import com.vmware.vim.vmomi.client.http.ThumbprintVerifier;

/**
 * A no-cache layer to encapsulate Horizon View Connection Server related operations,
 * for easy access.
 * 
 * @author nanw
 */
public class ViewOperatorNoCache implements AutoCloseable {
    ...
    public ViewOperatorNoCache(String host, String user, String password, String domain) {
        this.host = host;
        this.user = user;
    ...
    public ViewOperatorNoCache(Connection conn) {
        this.host = null;
        this.user = null;
        this.password = null;
        this.domain = null;
    ...
    public List<SessionLocalSummaryView> listLocalAppSessions() {
    	
    	SessionCName.SessionDataCName column = new SessionCName.SessionDataCName();
                
    	Query.QueryFilter filter = Query.QueryFilter.equals(column.sessionType, "APPLICATION");
    	//return listAll(SessionLocalSummaryView.class, filter);
    	return listAll(SessionLocalSummaryView.class);
    }
    ...
    public ADUserOrGroup.ADUserOrGroupSummaryView getADUserOrGroup(String name, String domain) {
        ...
        ADUserOrGroupCName.ADUserOrGroupSummaryViewCName ADUSER_GROUP_SUMMARY_VIEW_CNAME = new ADUserOrGroupCName.ADUserOrGroupSummaryViewCName();
